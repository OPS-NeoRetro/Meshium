...
public class MeshiumWorldRenderer {
    ...
    public void addDebugInfo(ArrayList<String> debugInfo) {
        ...
        if (this.asyncChunkTracker != null) {
            //Async BFS iteration time:, Build queue sizes:
            debugInfo.add("A-BFS: " + asyncChunkTracker.getIterationTime() + " Q: " + Arrays.toString(this.asyncChunkTracker.getBuildQueueSizes()));
        }
