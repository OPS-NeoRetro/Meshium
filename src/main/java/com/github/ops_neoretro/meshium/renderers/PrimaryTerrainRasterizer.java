...
import com.github.ops_neoretro.mixin.minecraft.LightMapAccessor;
...
import static com.github.ops_neoretro.RenderPipeline.GL_DRAW_INDIRECT_ADDRESS_NV;
...
public class PrimaryTerrainRasterizer extends Phase {
    ...
    private final Shader shader = Shader.make()
            .addSource(TASK, ShaderLoader.parse(Identifier.of("meshium", "terrain/task.glsl")))
            .addSource(MESH, ShaderLoader.parse(Identifier.of("meshium", "terrain/mesh.glsl")))
            .addSource(FRAGMENT, ShaderLoader.parse(Identifier.of("meshium", "terrain/frag.frag"))).compile();
