...
public class TranslucentTerrainRasterizer extends Phase {
    ...
    private final Shader shader = Shader.make()
            .addSource(TASK, ShaderLoader.parse(Identifier.of("meshium", "terrain/translucent/task.glsl")))
            .addSource(MESH, ShaderLoader.parse(Identifier.of("meshium", "terrain/translucent/mesh.glsl")))
            .addSource(FRAGMENT, ShaderLoader.parse(Identifier.of("meshium", "terrain/frag.frag"), builder->{builder.add("TRANSLUCENT_PASS");}))
            .compile();
