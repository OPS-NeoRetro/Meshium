...
import me.cortex.meshium.sodiumCompat.MeshiumCompactChunkVertex;
...
public class MeshiumWorldRenderer {
    ...
    public MeshiumWorldRenderer(AsyncOcclusionTracker asyncChunkTracker) {
        ...
        this.sectionManager = new SectionManager(device, max_geometry_memory*1024*1024, uploadStream, MeshiumCompactChunkVertex.STRIDE, this);
    ...
    public void renderFrame(Viewport viewport, ChunkRenderMatrices matrices, double x, double y, double z) {
        ...
        if (Meshium.SUPPORTS_PERSISTENT_SPARSE_ADDRESSABLE_BUFFER && (System.currentTimeMillis() - last_sample_time) > 60000) {
    ...
    public void addDebugInfo(ArrayList<String> debugInfo) {
        debugInfo.add("Using meshium renderer: "+ Meshium.MOD_VERSION);
        /*
    ...
    private void update_allowed_memory() {
        if (Meshium.config.automatic_memory) {
            ...
            max_geometry_memory = Meshium.config.max_geometry_memory;
        }
    }
