package me.cortex.meshium.api0;
...
public class MeshiumAPI {
    private final String modName;
    public MeshiumAPI(String modName) {
    ...
    public void hideSection(int x, int y, int z) {
        if (Meshium.IS_ENABLED) {
            var renderer = ((IMeshiumWorldRendererGetter) SodiumWorldRenderer.instance()).getRenderer();
            if (renderer != null) {
