...
public class RegionVisibilityTracker {
    private final Shader shader = Shader.make()
            .addSource(MESH, ShaderLoader.parse(Identifier.of("meshium", "occlusion/queries/region/mesh.glsl")))
            .addSource(FRAGMENT, ShaderLoader.parse(Identifier.of("meshium", "occlusion/queries/region/fragment.frag")))
            .compile();
